...
import ssSaldoQuebra from './Screenshot_20251118-115049.png'
import ssMasterGap from './Screenshot_20251118-113612.png'
import ssPedidoInicio from './Screenshot_20260117-124255.png'
import ssPedidoDetalhes from './Screenshot_20260117-124302.png'
import ssAssistente from './Screenshot_20260117-124449.png'
import ssConfirmacaoTermos from './Screenshot_20260118-084841.png'
import ssProcessando from './Screenshot_20260118-084933.png'
import ssTransferencia from './Screenshot_20260121-141342.png'
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      ...
      <div className="display">
        <Image src={ssSaldoQuebra} alt="Saldo no dia da quebra" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssMasterGap} alt="Banco Master tomando gap no app do FGC" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssPedidoInicio} alt="Tela inicial do pedido de garantia no app do FGC" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssPedidoDetalhes} alt="Detalhes do pedido de garantia" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssAssistente} alt="Assistente de solicitação de garantia" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssConfirmacaoTermos} alt="Confirmação dos dados de pagamento e aceite dos termos" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssProcessando} alt="Confirmação de que o pagamento está sendo processado" />
      </div>
    </div>
</div>
...
<div className="flex justify-center">
    <div className="mockup-phone border-0">
      <div className="camera"></div>
      <div className="display">
        <Image src={ssTransferencia} alt="Notificação de transferência recebida do FGC" />
      </div>
    </div>
</div>
...
<ul className="timeline timeline-vertical timeline-snap-icon">
  <li>
    <div className="timeline-start">18/11/2025</div>
    <div className="timeline-middle"></div>
    <div className="timeline-end timeline-box">Início do trâmite</div>
    <hr/>
  </li>
  <li>
    <div className="timeline-start">17/01/2026</div>
    <div className="timeline-middle"></div>
    <div className="timeline-end timeline-box">Liberação dos pedidos</div>
    <hr/>
  </li>
  <li>
    <div className="timeline-start">18/01/2026 8h</div>
    <div className="timeline-middle"></div>
    <div className="timeline-end timeline-box">Quando eu pedi</div>
    <hr/>
  </li>
  <li>
    <div className="timeline-start">21/01/2026 14h</div>
    <div className="timeline-middle"></div>
    <div className="timeline-end timeline-box">Recebimento do dinheiro</div>
    <hr/>
  </li>
</ul>
